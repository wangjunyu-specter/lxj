...
var OrdersuccessPage = /** @class */ (function () {
    ...
    OrdersuccessPage.prototype.gotoPage = function (type) {
        this.topage.toPage(type, this.orderId);
    };
