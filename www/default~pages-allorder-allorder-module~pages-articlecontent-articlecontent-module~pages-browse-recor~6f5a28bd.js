(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-allorder-allorder-module~pages-articlecontent-articlecontent-module~pages-browse-recor~6f5a28bd"],{
...
/* harmony import */ var _pipes_yhqtitle_pipe__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../pipes/yhqtitle.pipe */ "./src/app/pipes/yhqtitle.pipe.ts");
...
/* harmony import */ var _gwcitem_gwcitem_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./gwcitem/gwcitem.component */ "./src/app/components/gwcitem/gwcitem.component.ts");
/* harmony import */ var _emojipick_emojipick_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./emojipick/emojipick.component */ "./src/app/components/emojipick/emojipick.component.ts");
/* harmony import */ var _chatinputbox_chatinputbox_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./chatinputbox/chatinputbox.component */ "./src/app/components/chatinputbox/chatinputbox.component.ts");
/* harmony import */ var _services_emoji_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../services/emoji.service */ "./src/app/services/emoji.service.ts");
/* harmony import */ var _orderlist_orderlist_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./orderlist/orderlist.component */ "./src/app/components/orderlist/orderlist.component.ts");
/* harmony import */ var _ordercontentgoods_ordercontentgoods_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./ordercontentgoods/ordercontentgoods.component */ "./src/app/components/ordercontentgoods/ordercontentgoods.component.ts");
/* harmony import */ var _xclist_xclist_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./xclist/xclist.component */ "./src/app/components/xclist/xclist.component.ts");
...
var ComponentsModule = /** @class */ (function () {
    ...
    ComponentsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_emoji_service__WEBPACK_IMPORTED_MODULE_30__["EmojiService"]],
            exports: [_seletebtn_seletebtn_component__WEBPACK_IMPORTED_MODULE_5__["SeletebtnComponent"], _pagetitle_pagetitle_component__WEBPACK_IMPORTED_MODULE_4__["PagetitleComponent"], _productlist_productlist_component__WEBPACK_IMPORTED_MODULE_6__["ProductlistComponent"], _yhbox_yhbox_component__WEBPACK_IMPORTED_MODULE_7__["YhboxComponent"],
                ...
                _goodssort_goodssort_component__WEBPACK_IMPORTED_MODULE_20__["GoodssortComponent"], _contactlist_contactlist_component__WEBPACK_IMPORTED_MODULE_21__["ContactlistComponent"], _time_pipe__WEBPACK_IMPORTED_MODULE_16__["TimePipe"], _gwcitem_gwcitem_component__WEBPACK_IMPORTED_MODULE_27__["GwcitemComponent"],
                _pqimgbox_pqimgbox_component__WEBPACK_IMPORTED_MODULE_22__["PqimgboxComponent"], _pllist_pllist_component__WEBPACK_IMPORTED_MODULE_23__["PllistComponent"], _chatinputbox_chatinputbox_component__WEBPACK_IMPORTED_MODULE_29__["ChatinputboxComponent"], _orderlist_orderlist_component__WEBPACK_IMPORTED_MODULE_31__["OrderlistComponent"], _ordercontentgoods_ordercontentgoods_component__WEBPACK_IMPORTED_MODULE_32__["OrdercontentgoodsComponent"],
                _xclist_xclist_component__WEBPACK_IMPORTED_MODULE_33__["XclistComponent"]]
        })
    ], ComponentsModule);
...
module.exports = "<div class=\"my-content-bg\" *ngFor=\"let item of list; let i = index\">\n  <ion-list inset=\"true\" line=\"none\">\n    <div class=\"shopname-box\">\n      <div class=\"left\">\n        <img src=\"../../../assets/icon/dianpu.png\" alt=\"\"><h3 class=\"supper_name\" (click)=\"gotoPage(7, item.supplier_id)\">{{item.shopname}}</h3>\n      </div>\n      <div class=\"right\">{{item.order_status}}</div>\n    </div>\n    <ion-item *ngFor=\"let data of item.goods_list\" lines=\"none\" (click)=\"gotoPage(11, item.order_sn)\">\n      <ion-thumbnail slot=\"start\">\n        <img [src]=\"data.goods_thumb | imgsrc: http.domain\">\n      </ion-thumbnail>\n      <ion-label>\n        <h3 class=\"goods_title\">{{data.goods_name | namesubstr: 25}}</h3>\n        <p class=\"goods_title\" *ngFor=\"let item of data.goods_attr | xclistattr\">{{item}}</p>\n      </ion-label>\n      <div slot=\"end\" class=\"end-price\">\n        <span>{{data.formated_goods_price}}</span>\n        <span>×{{data.goods_number}}</span>\n      </div>\n    </ion-item>\n    <p class=\"order_des\">共{{item.count}}件商品&nbsp;&nbsp;¥:{{item.total_fee}}</p>\n  </ion-list>\n</div>"
...
module.exports = ".end-price {\n  font-size: 12px;\n  color: var(--ion-color-medium); }\n  .end-price span {\n    display: block;\n    text-align: right; }\n  .goods_title {\n  white-space: normal;\n  font-size: var(--ion-sm-text); }\n  .order_des {\n  font-size: var(--ion-sm-text);\n  color: var(--ion-color-medium);\n  text-align: right; }\n  .supper_name {\n  font-size: var(--ion-title); }\n  .shopname-box {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: 1px solid var(--ion-color-light); }\n  .shopname-box .left {\n    display: flex;\n    flex-direction: row;\n    justify-content: flex-start;\n    align-items: center;\n    padding: 7px 0; }\n  .shopname-box .left img {\n      width: 20px; }\n  .shopname-box .left h3 {\n      padding: 0;\n      margin: 0; }\n  .shopname-box .right {\n    font-size: var(--ion-sm-text);\n    color: var(--ion-color-medium); }\n  .my-content-bg {\n  background: #fff;\n  margin-bottom: 10px;\n  border-radius: 7px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var XclistComponent = /** @class */ (function () {
    ...
    XclistComponent.prototype.gotoPage = function (type, id) {
        this.topage.toPage(type, id);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
//# sourceMappingURL=default~pages-allorder-allorder-module~pages-articlecontent-articlecontent-module~pages-browse-recor~6f5a28bd.js.map